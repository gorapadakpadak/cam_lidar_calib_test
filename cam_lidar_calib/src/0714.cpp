...
public:
    LidarImageProjection() {
        ...
        cloud_sub.subscribe(nh, lidar_in_topic, 1);
        image_sub.subscribe(nh, camera_in_topic, 1);
        ...
        //sync = new message_filters::Synchronizer<SyncPolicy>(SyncPolicy(10), cloud_sub, image_sub, detection_sub);
